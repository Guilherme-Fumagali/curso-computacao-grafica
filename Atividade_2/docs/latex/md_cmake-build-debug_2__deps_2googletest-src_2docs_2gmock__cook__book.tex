...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md150}{}\doxysubsection{\texorpdfstring{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}{Changing a Mock Object's Behavior Based on the State}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md150}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md155}{}\doxysubsection{\texorpdfstring{Ignoring an Action\textquotesingle{}s Result}{Ignoring an Action's Result}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md155}
...
And that\textquotesingle{}s that.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}{}\doxysubsection{\texorpdfstring{Using g\+Mock and Threads}{Using gMock and Threads}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_UsingThreads}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching gMock How to Print Your Values}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md178}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using gMock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md179}
