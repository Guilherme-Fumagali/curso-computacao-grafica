...
\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet}{}\label{md_tests_2lib_2docs_2gmock__cheat__sheet}\index{gMock Cheat Sheet@{gMock Cheat Sheet}}
\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md117}%
\Hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md117}%
 \hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md118}{}\doxysection{\texorpdfstring{Defining a Mock Class}{Defining a Mock Class}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md118}
\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_MockClass}{}\doxysubsection{\texorpdfstring{Mocking a Normal Class}{Mocking a Normal Class}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_MockClass}
Given
...
\{\+: .callout .note\} {\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_MockTemplate}{}\doxysubsection{\texorpdfstring{Mocking a Class Template}{Mocking a Class Template}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_MockTemplate}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md119}{}\doxysubsection{\texorpdfstring{Specifying Calling Conventions for Mock Functions}{Specifying Calling Conventions for Mock Functions}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md119}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily \texorpdfstring{$<$}{<}objbase.\+h\texorpdfstring{$>$}{>}} on Windows.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_UsingMocks}{}\doxysection{\texorpdfstring{Using Mocks in Tests}{Using Mocks in Tests}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_UsingMocks}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_OnCall}{}\doxysection{\texorpdfstring{Setting Default Actions}{Setting Default Actions}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{ {\ttfamily ON\+\_\+\+CALL}}}. {\ttfamily ON\+\_\+\+CALL} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{ Knowing When to Expect}} for a more detailed discussion.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_ExpectCall}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{ {\ttfamily EXPECT\+\_\+\+CALL}}} in the Mocking Reference.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_MatcherList}{}\doxysection{\texorpdfstring{Matchers}{Matchers}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_MatcherList}
See the \doxysectlink{md_tests_2lib_2docs_2reference_2matchers}{Matchers Reference}{0}.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_ActionList}{}\doxysection{\texorpdfstring{Actions}{Actions}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_ActionList}
See the \doxysectlink{md_tests_2lib_2docs_2reference_2actions}{Actions Reference}{0}.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_CardinalityList}{}\doxysection{\texorpdfstring{Cardinalities}{Cardinalities}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_CardinalityList}
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md120}{}\doxysection{\texorpdfstring{Expectation Order}{Expectation Order}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md120}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md121}{}\doxysection{\texorpdfstring{Verifying and Resetting a Mock}{Verifying and Resetting a Mock}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md122}{}\doxysection{\texorpdfstring{Mock Classes}{Mock Classes}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md122}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md123}{}\doxysection{\texorpdfstring{Flags}{Flags}}\label{md_tests_2lib_2docs_2gmock__cheat__sheet_autotoc_md123}
\tabulinesep=1mm
