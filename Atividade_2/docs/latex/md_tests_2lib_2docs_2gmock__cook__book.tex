...
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book}{}\label{md_tests_2lib_2docs_2gmock__cook__book}\index{gMock Cookbook@{gMock Cookbook}}
\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md124}%
\Hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md124}%
 You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \doxysectlink{md_tests_2lib_2docs_2gmock__for__dummies}{the dummy guide}{0} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md125}{}\doxysection{\texorpdfstring{Creating Mock Classes}{Creating Mock Classes}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md125}
...
\end{DoxyItemize}\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md126}{}\doxysubsection{\texorpdfstring{Dealing with unprotected commas}{Dealing with unprotected commas}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md126}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md127}{}\doxysubsection{\texorpdfstring{Mocking Private or Protected Methods}{Mocking Private or Protected Methods}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md127}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md128}{}\doxysubsection{\texorpdfstring{Mocking Overloaded Methods}{Mocking Overloaded Methods}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md128}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md129}{}\doxysubsection{\texorpdfstring{Mocking Class Templates}{Mocking Class Templates}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md129}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_MockingNonVirtualMethods}{}\doxysubsection{\texorpdfstring{Mocking Non-\/virtual Methods}{Mocking Non-virtual Methods}}\label{md_tests_2lib_2docs_2gmock__cook__book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md130}{}\doxysubsection{\texorpdfstring{Mocking Free Functions}{Mocking Free Functions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md130}
...
If you are concerned about the performance overhead incurred by virtual functions, and profiling confirms your concern, you can combine this with the recipe for \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_MockingNonVirtualMethods}{mocking non-\/virtual methods}{2}.

Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_MockFunction}{Mock\+Function}{2} to mock the std\+::function.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md131}{}\doxysubsection{\texorpdfstring{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}{Old-Style <tt>MOCK\_METHODn</tt> Macros}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md131}
...
\end{longtabu}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_NiceStrictNaggy}{}\doxysubsection{\texorpdfstring{The Nice, the Strict, and the Naggy}{The Nice, the Strict, and the Naggy}}\label{md_tests_2lib_2docs_2gmock__cook__book_NiceStrictNaggy}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md132}{}\doxysubsection{\texorpdfstring{Alternative to Mocking Concrete Classes}{Alternative to Mocking Concrete Classes}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md132}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_DelegatingToFake}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Fake}{Delegating Calls to a Fake}}\label{md_tests_2lib_2docs_2gmock__cook__book_DelegatingToFake}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md133}{}\doxysubsection{\texorpdfstring{Delegating Calls to a Real Object}{Delegating Calls to a Real Object}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md133}
...
You can use the {\itshape delegating-\/to-\/real} technique to ensure that your mock has the same behavior as the real object while retaining the ability to validate calls. This technique is very similar to the \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_DelegatingToFake}{delegating-\/to-\/fake}{2} technique, the difference being that we use a real object instead of a fake. Here\textquotesingle{}s an example\+:
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md135}{}\doxysection{\texorpdfstring{Using Matchers}{Using Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md135}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md136}{}\doxysubsection{\texorpdfstring{Matching Argument Values Exactly}{Matching Argument Values Exactly}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md136}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md137}{}\doxysubsection{\texorpdfstring{Using Simple Matchers}{Using Simple Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md137}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_CombiningMatchers}{}\doxysubsection{\texorpdfstring{Combining Matchers}{Combining Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_SafeMatcherCast}{}\doxysubsection{\texorpdfstring{Casting Matchers}{Casting Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_SelectOverload}{}\doxysubsection{\texorpdfstring{Selecting Between Overloaded Functions}{Selecting Between Overloaded Functions}}\label{md_tests_2lib_2docs_2gmock__cook__book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md138}{}\doxysubsection{\texorpdfstring{Performing Different Actions Based on the Arguments}{Performing Different Actions Based on the Arguments}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md138}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md139}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md139}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md140}{}\doxysubsection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md140}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md141}{}\doxysubsection{\texorpdfstring{Using Matchers in googletest Assertions}{Using Matchers in googletest Assertions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md141}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md142}{}\doxysubsection{\texorpdfstring{Using Predicates as Matchers}{Using Predicates as Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md142}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \doxysectlink{md_tests_2lib_2docs_2reference_2matchers}{Matchers Reference}{0} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md143}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md143}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md144}{}\doxysubsection{\texorpdfstring{Validating a Member of an Object}{Validating a Member of an Object}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md144}
...
What if you want to validate more than one members at the same time? Remember that there are \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_CombiningMatchers}{\`{}\+All\+Of()\`{} and \`{}\+All\+Of\+Array()\`{}}{2}.
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md145}{}\doxysubsection{\texorpdfstring{Validating the Value Pointed to by a Pointer Argument}{Validating the Value Pointed to by a Pointer Argument}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md145}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_CustomMatcherClass}{}\doxysubsection{\texorpdfstring{Defining a Custom Matcher Class}{Defining a Custom Matcher Class}}\label{md_tests_2lib_2docs_2gmock__cook__book_CustomMatcherClass}
Most matchers can be simply defined using \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_NewMatchers}{the MATCHER\texorpdfstring{$\ast$}{*} macros}{2}, which are terse and flexible, and produce good error messages. However, these macros are not very explicit about the interfaces they create and are not always suitable, especially for matchers that will be widely reused.
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md146}{}\doxysubsection{\texorpdfstring{Matching Containers}{Matching Containers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md146}
...
\end{DoxyItemize}\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md147}{}\doxysubsection{\texorpdfstring{Sharing Matchers}{Sharing Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_PureMatchers}{}\doxysubsection{\texorpdfstring{Matchers must have no side-\/effects}{Matchers must have no side-effects}}\label{md_tests_2lib_2docs_2gmock__cook__book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md148}{}\doxysection{\texorpdfstring{Setting Expectations}{Setting Expectations}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md148}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_UseOnCall}{}\doxysubsection{\texorpdfstring{Knowing When to Expect}{Knowing When to Expect}}\label{md_tests_2lib_2docs_2gmock__cook__book_UseOnCall}
...
If you are bothered by the "{}\+Uninteresting mock function call"{} message printed when a mock method without an {\ttfamily EXPECT\+\_\+\+CALL} is called, you may use a {\ttfamily Nice\+Mock} instead to suppress all such messages for the mock object, or suppress the message for specific methods by adding {\ttfamily EXPECT\+\_\+\+CALL(...).Times(\+Any\+Number())}. DO NOT suppress it by blindly adding an {\ttfamily EXPECT\+\_\+\+CALL(...)}, or you\textquotesingle{}ll have a test that\textquotesingle{}s a pain to maintain.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md149}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Calls}{Ignoring Uninteresting Calls}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md149}
If you are not interested in how a mock method is called, just don\textquotesingle{}t say anything about it. In this case, if the method is ever called, g\+Mock will perform its default action to allow the test program to continue. If you are not happy with the default action taken by g\+Mock, you can override it using {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}::Set()} (described \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_DefaultValue}{here}{2}) or {\ttfamily ON\+\_\+\+CALL()}.

Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md150}{}\doxysubsection{\texorpdfstring{Disallowing Unexpected Calls}{Disallowing Unexpected Calls}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md150}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_uninteresting-vs-unexpected}{}\doxysubsection{\texorpdfstring{Understanding Uninteresting vs Unexpected Calls}{Understanding Uninteresting vs Unexpected Calls}}\label{md_tests_2lib_2docs_2gmock__cook__book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_NiceStrictNaggy}{"{}The Nice, the Strict, and the Naggy"{}}{2}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_ParameterlessExpectations}{}\doxysubsection{\texorpdfstring{Ignoring Uninteresting Arguments}{Ignoring Uninteresting Arguments}}\label{md_tests_2lib_2docs_2gmock__cook__book_ParameterlessExpectations}
...
This functionality is only available when a method is not overloaded; to prevent unexpected behavior it is a compilation error to try to set an expectation on a method where the specific overload is ambiguous. You can work around this by supplying a \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_SimplerInterfaces}{simpler mock interface}{2} than the mocked class provides.

This pattern is also useful when the arguments are interesting, but match logic is substantially complex. You can leave the argument list unspecified and use Save\+Arg actions to \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_SaveArgVerify}{save the values for later verification}{2}. If you do that, you can easily differentiate calling the method the wrong number of times from calling it with the wrong arguments.\hypertarget{md_tests_2lib_2docs_2gmock__for__dummies_OrderedCalls}{}\doxysubsection{\texorpdfstring{Expecting Ordered Calls}{Expecting Ordered Calls}}\label{md_tests_2lib_2docs_2gmock__for__dummies_OrderedCalls}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_PartialOrder}{}\doxysubsection{\texorpdfstring{Expecting Partially Ordered Calls}{Expecting Partially Ordered Calls}}\label{md_tests_2lib_2docs_2gmock__cook__book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md151}{}\doxysubsection{\texorpdfstring{Controlling When an Expectation Retires}{Controlling When an Expectation Retires}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md151}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily "{}\+File too large."{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md152}{}\doxysection{\texorpdfstring{Using Actions}{Using Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md152}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md153}{}\doxysubsection{\texorpdfstring{Returning References from Mock Methods}{Returning References from Mock Methods}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md153}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md154}{}\doxysubsection{\texorpdfstring{Returning Live Values from Mock Methods}{Returning Live Values from Mock Methods}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md154}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md155}{}\doxysubsection{\texorpdfstring{Combining Actions}{Combining Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md155}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_MockingSideEffects}{}\doxysubsection{\texorpdfstring{Mocking Side Effects}{Mocking Side Effects}}\label{md_tests_2lib_2docs_2gmock__cook__book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md156}{}\doxysubsection{\texorpdfstring{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}{Changing a Mock Object's Behavior Based on the State}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md156}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_tests_2lib_2docs_2reference_2mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md157}{}\doxysubsection{\texorpdfstring{Setting the Default Actions for a Mock Method}{Setting the Default Actions for a Mock Method}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md157}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same "{}later statements take precedence"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_FunctionsAsActions}{}\doxysubsection{\texorpdfstring{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}{Using Functions/Methods/Functors/Lambdas as Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md158}{}\doxysubsection{\texorpdfstring{Using Functions with Extra Info as Actions}{Using Functions with Extra Info as Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md158}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md159}{}\doxysubsection{\texorpdfstring{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}{Invoking a Function/Method/Functor/Lambda/Callback Without Arguments}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md159}
...
\end{DoxyItemize}\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md160}{}\doxysubsection{\texorpdfstring{Invoking an Argument of the Mock Function}{Invoking an Argument of the Mock Function}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md160}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md161}{}\doxysubsection{\texorpdfstring{Ignoring an Action\textquotesingle{}s Result}{Ignoring an Action's Result}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md161}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_SelectingArgs}{}\doxysubsection{\texorpdfstring{Selecting an Action\textquotesingle{}s Arguments}{Selecting an Action's Arguments}}\label{md_tests_2lib_2docs_2gmock__cook__book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md162}{}\doxysubsection{\texorpdfstring{Ignoring Arguments in Action Functions}{Ignoring Arguments in Action Functions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md162}
The \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_SelectingArgs}{selecting-\/an-\/action\textquotesingle{}s-\/arguments}{2} recipe showed us one way to make a mock function and an action with incompatible argument lists fit together. The downside is that wrapping the action in {\ttfamily With\+Args\texorpdfstring{$<$}{<}...\texorpdfstring{$>$}{>}()} can get tedious for people writing the tests.
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md163}{}\doxysubsection{\texorpdfstring{Sharing Actions}{Sharing Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md163}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md164}{}\doxysubsection{\texorpdfstring{Testing Asynchronous Behavior}{Testing Asynchronous Behavior}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md164}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md165}{}\doxysection{\texorpdfstring{Misc Recipes on Using g\+Mock}{Misc Recipes on Using gMock}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md165}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md166}{}\doxysubsection{\texorpdfstring{Mocking Methods That Use Move-\/\+Only Types}{Mocking Methods That Use Move-Only Types}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md166}
...
Mocking a method that takes and/or returns move-\/only types presents some challenges, but nothing insurmountable. This recipe shows you how you can do it. Note that the support for move-\/only method arguments was only introduced to g\+Mock in April 2017; in older code, you may find more complex \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_LegacyMoveOnly}{workarounds}{3} for lack of this feature.
...
If you are not happy with the default action, you can tweak it as usual; see \doxysectlink{md_tests_2lib_2docs_2gmock__cheat__sheet_OnCall}{Setting Default Actions}{1}.
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md167}{}\doxysubsection{\texorpdfstring{Making the Compilation Faster}{Making the Compilation Faster}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md167}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md168}{}\doxysubsection{\texorpdfstring{Forcing a Verification}{Forcing a Verification}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md168}
...
And that\textquotesingle{}s that.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_UsingThreads}{}\doxysubsection{\texorpdfstring{Using g\+Mock and Threads}{Using gMock and Threads}}\label{md_tests_2lib_2docs_2gmock__cook__book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md170}{}\doxysubsection{\texorpdfstring{Controlling How Much Information g\+Mock Prints}{Controlling How Much Information gMock Prints}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md170}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md171}{}\doxysubsection{\texorpdfstring{Gaining Super Vision into Mock Calls}{Gaining Super Vision into Mock Calls}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md171}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md172}{}\doxysubsection{\texorpdfstring{Running Tests in Emacs}{Running Tests in Emacs}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md172}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md173}{}\doxysection{\texorpdfstring{Extending g\+Mock}{Extending gMock}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md173}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_NewMatchers}{}\doxysubsection{\texorpdfstring{Writing New Matchers Quickly}{Writing New Matchers Quickly}}\label{md_tests_2lib_2docs_2gmock__cook__book_NewMatchers}
\{\+: .callout .warning\} WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \doxysectlink{md_tests_2lib_2docs_2gmock__cook__book_PureMatchers}{this section}{2} for more details.
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener\texorpdfstring{$\ast$}{*}} instead of {\ttfamily std\+::ostream\texorpdfstring{$\ast$}{*}}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md176}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Matchers}{Writing New Polymorphic Matchers}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md176}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md177}{}\doxysubsection{\texorpdfstring{Legacy Matcher Implementation}{Legacy Matcher Implementation}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md177}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md178}{}\doxysubsection{\texorpdfstring{Writing New Cardinalities}{Writing New Cardinalities}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md178}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_QuickNewActions}{}\doxysubsection{\texorpdfstring{Writing New Actions}{Writing New Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \doxylink{gmock-actions_8h_source}{gmock-\/actions.\+h}} for examples.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md179}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-based Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md179}
...
\end{longtabu}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md180}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based parameterized Actions}{Legacy macro-based parameterized Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md180}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md181}{}\doxysubsection{\texorpdfstring{Restricting the Type of an Argument or Parameter in an ACTION}{Restricting the Type of an Argument or Parameter in an ACTION}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md181}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md182}{}\doxysubsection{\texorpdfstring{Writing New Action Templates Quickly}{Writing New Action Templates Quickly}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md182}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md183}{}\doxysubsection{\texorpdfstring{Using the ACTION Object\textquotesingle{}s Type}{Using the ACTION Object's Type}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md183}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_NewMonoActions}{}\doxysubsection{\texorpdfstring{Writing New Monomorphic Actions}{Writing New Monomorphic Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_NewPolyActions}{}\doxysubsection{\texorpdfstring{Writing New Polymorphic Actions}{Writing New Polymorphic Actions}}\label{md_tests_2lib_2docs_2gmock__cook__book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md184}{}\doxysubsection{\texorpdfstring{Teaching g\+Mock How to Print Your Values}{Teaching gMock How to Print Your Values}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md184}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<}} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md185}{}\doxysection{\texorpdfstring{Useful Mocks Created Using g\+Mock}{Useful Mocks Created Using gMock}}\label{md_tests_2lib_2docs_2gmock__cook__book_autotoc_md185}
\hypertarget{md_tests_2lib_2docs_2gmock__cook__book_MockFunction}{}\doxysubsection{\texorpdfstring{Mock std\+::function}{Mock std::function}}\label{md_tests_2lib_2docs_2gmock__cook__book_MockFunction}
