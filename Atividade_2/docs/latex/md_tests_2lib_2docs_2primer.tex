...
\hypertarget{md_tests_2lib_2docs_2primer}{}\label{md_tests_2lib_2docs_2primer}\index{GoogleTest Primer@{GoogleTest Primer}}
\label{md_tests_2lib_2docs_2primer_autotoc_md227}%
\Hypertarget{md_tests_2lib_2docs_2primer_autotoc_md227}%
 \hypertarget{md_tests_2lib_2docs_2primer_autotoc_md228}{}\doxysection{\texorpdfstring{Introduction\+: Why Google\+Test?}{Introduction: Why GoogleTest?}}\label{md_tests_2lib_2docs_2primer_autotoc_md228}
...
\end{longtabu}
\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md230}{}\doxysection{\texorpdfstring{Basic Concepts}{Basic Concepts}}\label{md_tests_2lib_2docs_2primer_autotoc_md230}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md231}{}\doxysection{\texorpdfstring{Assertions}{Assertions}}\label{md_tests_2lib_2docs_2primer_autotoc_md231}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \doxysectlink{md_tests_2lib_2docs_2reference_2assertions}{Assertions Reference}{0}.\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md232}{}\doxysection{\texorpdfstring{Simple Tests}{Simple Tests}}\label{md_tests_2lib_2docs_2primer_autotoc_md232}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_2lib_2docs_2primer_same-data-multiple-tests}{}\doxysection{\texorpdfstring{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}{Test Fixtures: Using the Same Data Configuration for Multiple Tests}}\label{md_tests_2lib_2docs_2primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md233}{}\doxysection{\texorpdfstring{Invoking the Tests}{Invoking the Tests}}\label{md_tests_2lib_2docs_2primer_autotoc_md233}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md234}{}\doxysection{\texorpdfstring{Writing the main() Function}{Writing the main() Function}}\label{md_tests_2lib_2docs_2primer_autotoc_md234}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_tests_2lib_2docs_2primer_autotoc_md235}{}\doxysection{\texorpdfstring{Known Limitations}{Known Limitations}}\label{md_tests_2lib_2docs_2primer_autotoc_md235}
