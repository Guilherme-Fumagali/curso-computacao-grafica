...
\hypertarget{md_tests_2lib_2docs_2reference_2mocking}{}\label{md_tests_2lib_2docs_2reference_2mocking}\index{Mocking Reference@{Mocking Reference}}
\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md265}%
\Hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md265}%
 This page lists the facilities provided by Google\+Test for creating and working with mock objects. To use them, add {\ttfamily \#include \texorpdfstring{$<$}{<}\doxylink{gmock_8h_source}{gmock/gmock.\+h}\texorpdfstring{$>$}{>}}.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_macros}{}\doxysection{\texorpdfstring{Macros}{Macros}}\label{md_tests_2lib_2docs_2reference_2mocking_macros}
Google\+Test defines the following macros for working with mocks.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\_METHOD}}\label{md_tests_2lib_2docs_2reference_2mocking_MOCK_METHOD}
...
{\ttfamily MOCK\+\_\+\+METHOD} must be used in the {\ttfamily public\+:} section of a mock class definition, regardless of whether the method being mocked is {\ttfamily public}, {\ttfamily protected}, or {\ttfamily private} in the base class.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_EXPECT_CALL}{}\doxysubsection{\texorpdfstring{EXPECT\+\_\+\+CALL}{EXPECT\_CALL}}\label{md_tests_2lib_2docs_2reference_2mocking_EXPECT_CALL}
...
See details for each modifier clause below.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}{With \{\#EXPECT\_CALL.With\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md266}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\#EXPECT\_CALL.Times\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md267}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{InSequence \{\#EXPECT\_CALL.InSequence\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md268}
{\ttfamily .In\+Sequence(}\texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter \texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*} is any number of \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
See also the \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_InSequence}{\`{}\+In\+Sequence\`{} class}{2}.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}{After \{\#EXPECT\_CALL.After\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md269}
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily expectations...}\texorpdfstring{$\ast$}{*} can be up to five \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} or \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_ExpectationSet}{\`{}\+Expectation\+Set\`{}}{2} objects. The mock function call is expected to occur after all of the given expectations.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md270}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{WillOnce \{\#EXPECT\_CALL.WillOnce\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md270}
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily action}\texorpdfstring{$\ast$}{*} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \doxysectlink{md_tests_2lib_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md271}{}\doxysubsubsection{\texorpdfstring{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}{WillRepeatedly \{\#EXPECT\_CALL.WillRepeatedly\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md271}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md272}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{RetiresOnSaturation \{\#EXPECT\_CALL.RetiresOnSaturation\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md272}
...
The {\ttfamily Retires\+On\+Saturation} clause can be used at most once on an expectation and must be the last clause.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_ON_CALL}{}\doxysubsection{\texorpdfstring{ON\+\_\+\+CALL}{ON\_CALL}}\label{md_tests_2lib_2docs_2reference_2mocking_ON_CALL}
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily matchers...}\texorpdfstring{$\ast$}{*} is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method \texorpdfstring{$\ast$}{*}{\ttfamily method\+\_\+name}\texorpdfstring{$\ast$}{*}. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of \texorpdfstring{$\ast$}{*}{\ttfamily method\+\_\+name}\texorpdfstring{$\ast$}{*} whose arguments match all of the matchers. If {\ttfamily (}\texorpdfstring{$\ast$}{*}{\ttfamily matchers...}\texorpdfstring{$\ast$}{*}{\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the \doxysectlink{md_tests_2lib_2docs_2reference_2matchers}{Matchers Reference}{0} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md273}{}\doxysubsubsection{\texorpdfstring{With \{\#\+ON\+\_\+\+CALL.\+With\}}{With \{\#ON\_CALL.With\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md273}
{\ttfamily .With(}\texorpdfstring{$\ast$}{*}{\ttfamily multi\+\_\+argument\+\_\+matcher}\texorpdfstring{$\ast$}{*}{\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_autotoc_md274}{}\doxysubsubsection{\texorpdfstring{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{WillByDefault \{\#ON\_CALL.WillByDefault\}}}\label{md_tests_2lib_2docs_2reference_2mocking_autotoc_md274}
...
The {\ttfamily Will\+By\+Default} clause must be used exactly once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_classes}{}\doxysection{\texorpdfstring{Classes}{Classes}}\label{md_tests_2lib_2docs_2reference_2mocking_classes}
Google\+Test defines the following classes for working with mocks.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_DefaultValue}{}\doxysubsection{\texorpdfstring{Setting the Default Value for a Return Type}{Setting the Default Value for a Return Type}}\label{md_tests_2lib_2docs_2reference_2mocking_DefaultValue}
...
\end{DoxyCode}
\hypertarget{md_tests_2lib_2docs_2reference_2mocking_NiceMock}{}\doxysubsection{\texorpdfstring{Nice\+Mock}{NiceMock}}\label{md_tests_2lib_2docs_2reference_2mocking_NiceMock}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_NaggyMock}{}\doxysubsection{\texorpdfstring{Naggy\+Mock}{NaggyMock}}\label{md_tests_2lib_2docs_2reference_2mocking_NaggyMock}
...
\doxylink{classMock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{StrictMock}}\label{md_tests_2lib_2docs_2reference_2mocking_StrictMock}
...
{\ttfamily Strict\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_Sequence}{}\doxysubsection{\texorpdfstring{Sequence}{Sequence}}\label{md_tests_2lib_2docs_2reference_2mocking_Sequence}
{\ttfamily \+::testing\+::\+Sequence}

Represents a chronological sequence of expectations. See the \`{}\+In\+Sequence\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL} for usage.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_InSequence}{}\doxysubsection{\texorpdfstring{In\+Sequence}{InSequence}}\label{md_tests_2lib_2docs_2reference_2mocking_InSequence}
...
The name of the {\ttfamily In\+Sequence} object does not matter.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_Expectation}{}\doxysubsection{\texorpdfstring{Expectation}{Expectation}}\label{md_tests_2lib_2docs_2reference_2mocking_Expectation}
{\ttfamily \+::testing\+::\+Expectation}

Represents a mock function call expectation as created by \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_EXPECT_CALL}{\`{}\+EXPECT\+\_\+\+CALL\`{}}{2}\+:
...
Useful for specifying sequences of expectations; see the \`{}\+After\`{} clause of {\ttfamily EXPECT\+\_\+\+CALL}.\hypertarget{md_tests_2lib_2docs_2reference_2mocking_ExpectationSet}{}\doxysubsection{\texorpdfstring{Expectation\+Set}{ExpectationSet}}\label{md_tests_2lib_2docs_2reference_2mocking_ExpectationSet}
{\ttfamily \+::testing\+::\+Expectation\+Set}

Represents a set of mock function call expectations.

Use the {\ttfamily +=} operator to add \doxysectlink{md_tests_2lib_2docs_2reference_2mocking_Expectation}{\`{}\+Expectation\`{}}{2} objects to the set\+:
