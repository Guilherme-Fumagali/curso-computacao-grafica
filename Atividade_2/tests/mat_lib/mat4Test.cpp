...
TEST(Mat4, AdditionWithNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
    mat4 m2(vec4(-17, -18, -19, -20), vec4(-21, -22, -23, -24), vec4(-25, -26, -27, -28), vec4(-29, -30, -31, -32));
...
TEST(Mat4, AdditionWithPositiveAndNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
    mat4 m2(vec4(1, 2, 3, 4), vec4(5, 6, 7, 8), vec4(9, 10, 11, 12), vec4(13, 14, 15, 16));
...
TEST(Mat4, SubtractionWithNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
    mat4 m2(vec4(-17, -18, -19, -20), vec4(-21, -22, -23, -24), vec4(-25, -26, -27, -28), vec4(-29, -30, -31, -32));
...
TEST(Mat4, SubtractionWithPositiveAndNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
    mat4 m2(vec4(1, 2, 3, 4), vec4(5, 6, 7, 8), vec4(9, 10, 11, 12), vec4(13, 14, 15, 16));
...
TEST(Mat4, MultiplicationWithNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
...
TEST(Mat4, DivisionWithNegativeValues) {
    mat4 m1(vec4(-1, -2, -3, -4), vec4(-5, -6, -7, -8), vec4(-9, -10, -11, -12), vec4(-13, -14, -15, -16));
