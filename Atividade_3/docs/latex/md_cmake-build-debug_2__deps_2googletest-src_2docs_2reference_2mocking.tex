...
Google\+Test defines the following macros for working with mocks.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}{}\doxysubsection{\texorpdfstring{MOCK\+\_\+\+METHOD}{MOCK\_METHOD}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_MOCK_METHOD}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}{Times \{\#EXPECT\_CALL.Times\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md264}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}{InSequence \{\#EXPECT\_CALL.InSequence\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md265}
{\ttfamily .In\+Sequence(}\texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*}{\ttfamily )}

Specifies that the mock function call is expected in a certain sequence.

The parameter \texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*} is any number of \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}{}\doxysubsubsection{\texorpdfstring{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}{WillOnce \{\#EXPECT\_CALL.WillOnce\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md267}
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily action}\texorpdfstring{$\ast$}{*} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \doxysectlink{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}{RetiresOnSaturation \{\#EXPECT\_CALL.RetiresOnSaturation\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md269}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md271}{}\doxysubsubsection{\texorpdfstring{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}{WillByDefault \{\#ON\_CALL.WillByDefault\}}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_autotoc_md271}
...
\end{DoxyCode}
\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}{}\doxysubsection{\texorpdfstring{Nice\+Mock}{NiceMock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NiceMock}
...
{\ttfamily Nice\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}} might not work correctly if the destructor of {\ttfamily T} is not virtual.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}{}\doxysubsection{\texorpdfstring{Naggy\+Mock}{NaggyMock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_NaggyMock}
...
\doxylink{classMock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{StrictMock}}\label{md_cmake-build-debug_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
