 ...
 * This function calculates the color of a ray by checking if it hits in a triangle in the scene.
 * This triangle is centered at the origin and has a height of 1.
 * If it hits the triangle, the color red is returned, otherwise the color of the sky is returned.
 *
...
int main() {
    ...
    MatrixIOImage::generateImageFromMatrix(matrix, image_width, image_height, "triangle.png");
